...
export default function Dashboard({ sp, projectsp, context }: DashboardProps) {
  ...
  function processDashboardData(
    ...
    const overdueInvoices = filteredInvoiceItems.filter(inv => {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <Stack horizontal horizontalAlign="space-between" tokens={{ childrenGap: 15 }} wrap>
        ...
        <DashboardCard title="Overdue" value={state.overdueInvoices} icon="WarningSolid" color="#eb6939ff" />
